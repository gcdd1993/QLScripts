...
async function main() {
  ...
  const header = {
    ...
    "Content-Length": "2",
    "User-Agent":
      "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148/sa-sdk-ios (com.unionpay.chsp) (cordova 4.5.4) (updebug 0) (version 938) (UnionPay/1.0 CloudPay) (clientVersion 198) (language zh_CN) (upHtml) (walletMode 00)",
  ...
  const payload = {};
  axios
    .post("https://youhui.95516.com/newsign/api/daily_sign_in", payload, { headers: header })
    .then((res) => {
      ...
      notify.sendNotify(
        ...
        "签到" +
          ...
          "\n" +
          "这个月连续签到天数：" +
          res.data.signInDays["current"]["days"]
      );
      console.log(
        "签到" +
          result +
